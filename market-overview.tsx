...
export const MarketOverview = memo(function MarketOverview({ realm, league, onItemClick, backendOnline }: MarketOverviewProps) {
  const { t } = useI18n();
  ...
  // Safety: wrapped in try-catch to prevent React #310 crash if data is malformed.
