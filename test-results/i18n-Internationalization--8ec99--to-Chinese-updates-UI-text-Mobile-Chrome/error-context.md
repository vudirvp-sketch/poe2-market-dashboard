...
- Name: i18n.spec.ts >> Internationalization (i18n) >> switching language to Chinese updates UI text
- Location: e2e\i18n.spec.ts:76:7
...
Call log:
  - waiting for locator('button[aria-label="Switch language"], button[aria-label="切换语言"]').first()
