...
export const FlipsTab = memo(function FlipsTab({ backendOnline, upstreamDegraded }: FlipsTabProps) {
  ...
  const filteredOpportunities = useMemo(() => {
    ...
    // Fix: Apply client-side score recomputation when backend returns score = 0.
    // This follows PoE2_Flipper_Canonical_Formulas.md §7 exactly.
    // Only recomputes scores that are 0; preserves valid backend scores.
    const scored = recomputeAllFlipScores(flipsData.opportunities);
