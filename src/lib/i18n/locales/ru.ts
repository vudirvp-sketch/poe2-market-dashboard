...
const ru: Record<TranslationKeys, string> = {
  ...
  flipsGoldFeesExcluded: "Золотые комиссии НЕ учтены в расчётах",
  flipsGoldFeesExcludedDesc: "Оценки спреда и прибыли не учитывают золотые комиссии PoE2, которые могут достигать 24% и зависят от направления. Реальная прибыль может быть ниже указанной.",
