...
const ko: Record<TranslationKeys, string> = {
  ...
  // ---- Recipes Tab ----
  tabRecipes: "레시피",
  recipesTitle: "상점 레시피 차익거래",
  recipesDescription: "상점 레시피를 통해 화폐 샤드를 상인에서 오브로 교환할 수 있습니다. 샤드의 시장 가격이 결과 오브 가치에서 골드 수수료를 뺀 것보다 낮으면 레시피가 수익성이 있게 됩니다. 가격은 실시간 시장 데이터로 확인되며 정식 공식에 따라 골드 수수료가 계산됩니다.",
  recipesProfitableCount: "수익성 레시피",
  recipesTotalChecked: "총 확인",
  recipesBestProfit: "최고 수익",
  recipesNoData: "레시피 데이터를 사용할 수 없음",
  recipesNoDataDesc: "백엔드가 실행 중이고 레시피 계산에 충분한 가격 데이터를 제공하는지 확인하세요.",
  recipesNoProfitable: "수익성 있는 상점 레시피 없음",
  recipesNoProfitableDesc: "현재 시장 조건에서는 수익성 있는 상점 레시피가 없습니다. 안정적인 시장 단계에서는 일반적입니다. 샤드 가격이 변동될 때 나중에 확인하세요.",
  recipesName: "레시피",
  recipesInputCost: "투입 비용",
  recipesOutputValue: "산출 가치",
  recipesGoldFee: "골드 수수료",
  recipesProfit: "수익",
  recipesProfitPct: "수익률",
  recipesStatus: "상태",
  recipesMissingPrices: "가격 누락",
  recipesProfitable: "수익성",
  recipesUnprofitable: "비수익성",
  recipesShowUnprofitable: "비수익성 레시피 보기 ({0})",
  recipesHideUnprofitable: "비수익성 레시피 숨기기",
