...
const ko: Record<TranslationKeys, string> = {
  ...
  phaseHintsLivePriceLabel: "가격",
  phaseHintsChangeWeekLabel: "7일",
  phaseHintsChangeMonthLabel: "30일",
  phaseHintsMomentumUp: "상승",
  phaseHintsMomentumDown: "하락",
  phaseHintsMomentumFlat: "보합",
  phaseHintsRecBuyOpportunity: "매수 — 하락 기회",
  phaseHintsRecHold: "홀드",
  phaseHintsRecWatch: "관찰",
  phaseHintsRecSellIntoStrength: "매도 — 강세 활용",
  phaseHintsRecSellNow: "즉시 매도",
  phaseHintsRecNeutral: "중립",
  // F7 / P8 (iter 97) — Circuit Patterns 탭 (궤적 분류)
  tabCircuitPatterns: "궤적",
  fallbackCircuitPatterns: "시장 궤적 — 궤적 분류",
  circuitTitle: "궤적 — 보유 / 매도 / 회피",
  circuitSubtitle: "지난 {0}일 창에서 각 통화의 궤적. EXPONENTIAL_GROWTH → 보유. PEAK_THEN_DECLINE → 즉시 매도. DECLINING → 회피. VOLATILE → 차익 거래 주시.",
  circuitOffline: "궤적 분석은 백엔드가 필요합니다.",
  circuitOfflineHint: "FastAPI 백엔드를 시작하여 궤적 분류를 활성화하세요.",
  circuitLoading: "궤적 분류 중...",
  circuitError: "궤적 분류에 실패했습니다. 백엔드에 문제가 있을 수 있습니다.",
  circuitNoData: "아직 가격 기록이 없습니다 — 스케줄러가 더 많은 스냅샷을 수집해야 합니다.",
  circuitNoPatterns: "현재 창에 실행 가능한 패턴이 없습니다 — 모든 통화가 STABLE 또는 MEAN_REVERTING입니다.",
  circuitRefresh: "새로고침",
  circuitFetchedAt: "가져온 시간: {0}",
  circuitPatternCount: "{0}개 패턴",
  circuitFilterLabel: "궤적별 필터",
  circuitFilterAll: "전체",
  circuitFilterExpGrowth: "지수 성장",
  circuitFilterLinGrowth: "선형 성장",
  circuitFilterPeak: "피크→하락",
  circuitFilterMeanRev: "평균 회귀",
  circuitFilterVolatile: "변동성",
  circuitFilterDeclining: "하락 중",
  circuitFilterStable: "안정",
  circuitDaysLabel: "룩백 창 (일)",
  circuitDaysValue: "{0}일",
  circuitTotalChangeTitle: "룩백 창 내 첫 가격과 마지막 가격 간 총 % 변화",
  circuitSlopeTitle: "최근 기울기 (일당 %, 평균 가격으로 정규화)",
  circuitVolatilityTitle: "창 내 변동 계수 (표준편차 / 평균)",
  circuitRSquaredTitle: "선형 회귀 적합도 (0..1). 0 = 선형 추세 없음.",
  circuitDaysSincePeakTitle: "피크 가격 이후 경과 일수 (PEAK_THEN_DECLINE 전용)",
  circuitSampleSizeTitle: "룩백 창 내 가격 포인트 수",
  circuitCurrentPriceTitle: "기준 통화 기준 최근 가격",
  circuitTrajExpGrowth: "지수 성장",
  circuitTrajLinGrowth: "선형 성장",
  circuitTrajPeak: "피크 후 하락",
  circuitTrajMeanRev: "평균 회귀",
  circuitTrajVolatile: "변동성",
  circuitTrajDeclining: "하락 중",
  circuitTrajStable: "안정",
  circuitActionHoldForGrowth: "성장 보유",
  circuitActionSellNow: "즉시 매도",
  circuitActionAvoid: "회피",
  circuitActionWatch: "주시",
  circuitActionNeutral: "중립",
  circuitSampleSize: "{0} 포인트",
  circuitCurrent: "현재 {0}",
  circuitVolatility: "변동 {0}",
  circuitSlope: "기울기 {0}%/일",
  circuitRSquared: "R² {0}",
  circuitDaysSincePeak: "피크 {0}일 전",

  // P4 (iter 98) — Intraday Patterns tab (time-of-day heatmap)
  tabIntradayPatterns: "시간대별",
  fallbackIntradayPatterns: "시간대별 패턴 — 시간별 히트맵",
  intradayTitle: "시간대별 패턴 — 매수/매도 윈도우",
  intradaySubtitle: "최근 {0}일 동안 각 통화의 UTC 시간별 가격 패턴. 매수 윈도우 = 평균 최저 시간 (아시아 접속 시간). 매도 윈도우 = 평균 최고 시간 (미주/유럽 접속 시간).",
  intradayOffline: "시간대별 패턴은 분석 백엔드가 필요합니다.",
  intradayOfflineHint: "시간대별 패턴 감지를 활성화하려면 FastAPI 백엔드를 시작하세요.",
  intradayLoading: "시간대별 패턴 집계 중...",
  intradayError: "시간대별 패턴 집계에 실패했습니다. 백엔드에 문제가 있을 수 있습니다.",
  intradayNoData: "아직 가격 기록이 부족합니다 — 시간대별 패턴을 감지하려면 스케줄러가 여러 시간대에 걸쳐 더 많은 스냅샷을 수집해야 합니다.",
  intradayNoPatterns: "현재 창에 패턴 없음 — 모든 통화가 필터링됨 (MIN_SAMPLE_SIZE 미만 또는 1시간만 커버).",
  intradayNoSignificant: "유의미한 패턴 없음 (범위 < 10%). 모든 통화를 보려면 필터를 끄세요.",
  intradayRefresh: "새로고침",
  intradayFetchedAt: "가져온 시간: {0}",
  intradayPatternCount: "{0}개 패턴",
  intradayFilterSignificant: "유의미만",
  intradayDaysLabel: "조회 기간 (일)",
  intradayDaysValue: "{0}일",
  intradaySignificant: "유의미",
  intradayBuyWindow: "매수 {0}",
  intradaySellWindow: "매도 {0}",
  intradayBuyWindowTitle: "평균 가격이 가장 낮은 UTC 시간 (최적 매수 시간)",
  intradaySellWindowTitle: "평균 가격이 가장 높은 UTC 시간 (최적 매도 시간)",
  intradayRangeTitle: "|매도 평균 - 매수 평균| / 전체 평균 × 100 — 시간대별 패턴의 크기",
  intradayRange: "범위 {0}",
  intradayHourAxisLabel: "UTC 시간 (0-23)",
  intradayHeatmapAriaLabel: "{0}의 시간별 가격 히트맵",
  intradaySampleSizeTitle: "조회 기간 내 총 가격 포인트 수",
  intradayOverallMeanTitle: "모든 시간대 모든 가격 포인트의 평균",
  intradayCurrentPriceTitle: "기본 통화 최근 가격",
  intradayBuyMeanTitle: "매수 윈도우 시간의 평균 가격",
  intradaySellMeanTitle: "매도 윈도우 시간의 평균 가격",
  intradaySampleSize: "{0}개",
  intradayOverallMean: "전체 {0}",
  intradayCurrent: "현재 {0}",
  intradayBuyMean: "매수 {0}",
  intradaySellMean: "매도 {0}",
  intradayLegendLabel: "범례",
  intradayLegendBuy: "매수 구역 (≥5% 낮음)",
  intradayLegendMildBuy: "약한 매수 (2-5% 낮음)",
  intradayLegendNeutral: "중립 (±2%)",
  intradayLegendMildSell: "약한 매도 (2-5% 높음)",
  intradayLegendSell: "매도 구역 (≥5% 높음)",
  intradayLegendNoData: "데이터 없음",

  // P5 (iter 99) — Weekly Patterns tab (weekday/weekend heatmap)
  tabWeeklyPatterns: "주간",
  fallbackWeeklyPatterns: "주간 패턴 — 평일/주말 히트맵",
  weeklyTitle: "주간 패턴 — 매수 / 매도일",
  weeklySubtitle: "지난 {0}주 동안의 요일별(월-일) 가격 패턴. 매수일 = 평균이 가장 낮은 요일(주중 공급 안정). 매도일 = 평균이 가장 높은 요일(주말 수요 급증).",
  weeklyOffline: "주간 패턴은 분석 백엔드가 필요합니다.",
  weeklyOfflineHint: "FastAPI 백엔드를 시작하여 평일/주말 패턴 감지를 활성화하세요.",
  weeklyLoading: "요일별 패턴 집계 중...",
  weeklyError: "주간 패턴 집계에 실패했습니다. 백엔드에 문제가 있을 수 있습니다.",
  weeklyNoData: "아직 가격 기록이 없습니다 — 스케줄러가 여러 요일에 걸쳐 더 많은 스냅샷을 수집해야 주간 패턴을 감지할 수 있습니다.",
  weeklyNoPatterns: "현재 창에 패턴이 없습니다 — 모든 통화가 필터링되었습니다(MIN_SAMPLE_SIZE 미만 또는 1개 요일만 커버).",
  weeklyNoSignificant: "유의미한 패턴 없음(범위 < 10%). 필터를 끄면 모든 통화를 볼 수 있습니다.",
  weeklyRefresh: "새로고침",
  weeklyFetchedAt: "가져온 시간: {0}",
  weeklyPatternCount: "{0}개 패턴",
  weeklyFilterSignificant: "유의미만",
  weeklyWeeksLabel: "룩백 윈도우(주)",
  weeklyWeeksValue: "{0}주",
  weeklySignificant: "유의미",
  weeklyBuyDay: "매수 {0}",
  weeklySellDay: "매도 {0}",
  weeklyBuyDayTitle: "평균 가격이 가장 낮은 요일(최적 매수일)",
  weeklySellDayTitle: "평균 가격이 가장 높은 요일(최적 매도일)",
  weeklyRangeTitle: "|sell_mean - buy_mean| / overall_mean × 100 — 주간 패턴의 크기",
  weeklyRange: "범위 {0}",
  weeklyWeekdayAxisLabel: "요일(월-일)",
  weeklyWeekdayMon: "월",
  weeklyWeekdayTue: "화",
  weeklyWeekdayWed: "수",
  weeklyWeekdayThu: "목",
  ...
  weeklyWeekdaySat: "토",
  weeklyWeekdaySun: "일",
  weeklyHeatmapAriaLabel: "{0}의 주간 가격 히트맵",
  weeklySampleSizeTitle: "룩백 윈도우의 총 가격 포인트 수",
  weeklyOverallMeanTitle: "모든 요일의 모든 가격 포인트 평균",
  weeklyCurrentPriceTitle: "기준 통화의 최근 가격",
  weeklyBuyMeanTitle: "매수 윈도우 일의 평균 가격",
  weeklySellMeanTitle: "매도 윈도우 일의 평균 가격",
  weeklyWeekendDeltaTitle: "부호 있는 % 차이: (weekend_mean - weekday_mean) / overall_mean × 100. 양수 = 주말이 더 비쌈.",
  weeklySampleSize: "{0} 포인트",
  weeklyOverallMean: "전체 {0}",
  weeklyCurrent: "현재 {0}",
  weeklyBuyMean: "매수 {0}",
  weeklySellMean: "매도 {0}",
  weeklyWeekendDelta: "Δ 주말 {0}",
  weeklyLegendLabel: "범례",
  weeklyLegendBuy: "매수 구역 (≥5% 낮음)",
  weeklyLegendMildBuy: "약한 매수 (2-5% 낮음)",
  weeklyLegendNeutral: "중립 (±2%)",
  weeklyLegendMildSell: "약한 매도 (2-5% 높음)",
  weeklyLegendSell: "매도 구역 (≥5% 높음)",
  weeklyLegendNoData: "데이터 없음",

  // Leveling Uniques Lifecycle (P3, iter 100) — Overview 탭의 위젯
  levelingTitle: "레벨링 유니크",
  levelingDayCount: "{0}일차",
  levelingItemCount: "{0}개 아이템",
  levelingReferenceCurrency: "기준: {0}",
  levelingOffline: "레벨링 유니크 데이터는 분석 백엔드가 필요합니다.",
  levelingLoading: "레벨링 유니크 수명 주기 로딩 중...",
  levelingError: "레벨링 유니크 로드 실패. 백엔드에 문제가 있을 수 있습니다.",
  levelingNoData: "레벨링 유니크를 사용할 수 없습니다 — PhaseDetector가 현재 리그 일차를 결정할 수 없습니다.",
  levelingNoUniques: "정적 테이블에 레벨링 유니크가 없습니다.",
  levelingRefresh: "새로고침",
  levelingFetchedAt: "가져온 시간: {0}",
  levelingStageBreakdown: "피크 전: {0} · 피크 중: {1} · 피크 후: {2}",
  levelingSummaryAtPeak: "{0}개 아이템이 수요 피크 — 가지고 있으면 지금 판매하세요.",
  levelingSummaryPrePeak: "{0}개 아이템이 피크를 향해 상승 중 — 구매 또는 보유.",
  levelingSummaryPostPeak: "{0}개 아이템이 피크 이후 — 구매 금지 (가격 하락).",
  levelingStagePrePeak: "피크 전",
  levelingStageAtPeak: "피크 중",
  levelingStagePostPeak: "피크 후",
  levelingStageUnknown: "알 수 없음",
  levelingRecBuyOrHold: "구매/보유",
  levelingRecSellNow: "지금 판매",
  levelingRecAvoidBuying: "구매 금지",
  levelingRecUnknown: "—",
  levelingColItem: "아이템",
  levelingColStage: "단계",
  levelingColEstPrice: "예상가",
  levelingColPeakDay: "피크일",
  levelingColAction: "행동",
  levelingPeakDayShort: "{0}일차",
  levelingDisclaimer: "예상 가격은 리그 일차를 기반으로 한 휴리스틱이며, 실시간 시장 가격이 아닙니다. 거래 전 실제 등록 가격을 항상 확인하세요.",
  fallbackLevelingUniques: "레벨링 유니크 위젯",

  // Mirror/Divine Arbitrage (P7, iter 109) — 단일 객체 비율 디텍터 탭
  tabMirrorDivineArb: "Mirror/Div",
  fallbackMirrorDivineArb: "Mirror/Divine 차익거래 — 비율 디텍터",
  mirrorDivineTitle: "Mirror ↔ Divine 차익거래",
  mirrorDivineSubtitle: "현재 Mirror:Divine 비율 vs 최근 {0}일 창 평균. |z| ≥ 1.5 → EXECUTE_ARB. |z| ∈ [1.0, 1.5) → WATCH. |z| < 1.0 → HOLD.",
  mirrorDivineOffline: "Mirror/Divine 차익거래는 분석 백엔드가 필요합니다.",
  mirrorDivineOfflineHint: "FastAPI 백엔드를 시작하여 비율 디텍터를 활성화하세요.",
  mirrorDivineLoading: "Mirror:Divine 비율 계산 중...",
  mirrorDivineError: "Mirror:Divine 비율 계산 실패. 백엔드에 문제가 있을 수 있습니다.",
  mirrorDivineNoData: "가격 이력이 없습니다 — 비율을 분석하려면 스케줄러가 더 많은 Mirror 및 Divine 가격 스냅샷을 수집해야 합니다.",
  mirrorDivineNoSample: "룩백 창에 비율 포인트가 부족합니다 (≥ 4 필요). 룩백 창을 넓혀보세요.",
  mirrorDivineRefresh: "새로고침",
  mirrorDivineFetchedAt: "가져온 시간: {0}",
  mirrorDivineDaysLabel: "룩백 창 (일)",
  mirrorDivineDaysValue: "{0}일",
  mirrorDivineSignalLabel: "신호",
  mirrorDivineSignalSellMirror: "MIRROR 매도 / DIVINE 매수",
  mirrorDivineSignalSellDivine: "DIVINE 매도 / MIRROR 매수",
  mirrorDivineSignalNeutral: "중립",
  mirrorDivineActionLabel: "행동",
  mirrorDivineActionExecute: "차익 실행",
  mirrorDivineActionWatch: "관찰",
  mirrorDivineActionHold: "보유",
  mirrorDivineCurrentRate: "현재 비율",
  mirrorDivineCurrentRateTitle: "가장 최근 mirror_price / divine_price (Mirror당 Div)",
  mirrorDivineRateUnit: "Div / Mirror",
  mirrorDivineZScore: "z-점수",
  mirrorDivineZScoreTitle: "(현재 - 평균) / 표준편차. |z| ≥ 1.5 → 실행 가능한 신호.",
  mirrorDivineZScoreHint: "+과대평가 · -저평가",
  mirrorDivineDeviation: "편차",
  mirrorDivineDeviationTitle: "평균으로부터 부호 있는 % 편차. 양수 = Mirror가 Div 대비 과대평가.",
  mirrorDivineDeviationHint: "창 평균 대비",
  mirrorDivineProfit: "Mirror당 이익:",
  mirrorDivineProfitTitle: "|현재 - 평균| (Mirror당 Div). 1 Mirror 스왑에 대한 차익 이익 잠재력.",
  mirrorDivineActionable: "실행 가능:",
  mirrorDivineActionableYes: "예",
  mirrorDivineActionableNo: "아니오",
  mirrorDivineMean: "평균",
  mirrorDivineMeanTitle: "룩백 창 동안 비율의 과거 평균",
  mirrorDivineStd: "표준편차",
  mirrorDivineStdTitle: "창 동안 비율의 표본 표준편차 (ddof=1)",
  mirrorDivineMin: "최소",
  mirrorDivineMinTitle: "창에서 관찰된 최저 비율",
  mirrorDivineMax: "최대",
  mirrorDivineMaxTitle: "창에서 관찰된 최고 비율",
  mirrorDivineSampleSizeLabel: "포인트",
  mirrorDivineSampleSizeTitle: "룩백 창의 비율 포인트 수",
  mirrorDivineSampleSize: "{0}개",
  mirrorDivineSparklineLabel: "룩백 창 동안 Mirror:Divine 비율",

  // Gold Map ROI (P10 Phase 1 MVP, iter 127) — Castaway 실행 ROI 계산기
  tabGoldMapRoi: "Gold ROI",
  fallbackGoldMapRoi: "Gold Map ROI — Castaway 실행",
  goldMapTitle: "ROI Gold Map (Castaway)",
  goldMapSubtitle: "골드 → Div 변환(최적 3-way 체인) 후 지도 비용 차감. ROI > 50%일 때 파밍 권장.",
  goldMapOffline: "Gold Map ROI는 분석 백엔드가 필요합니다.",
  goldMapOfflineHint: "3-way 사이클 감지를 활성화하려면 FastAPI 백엔드를 시작하세요.",
  goldMapLoading: "3-way 사이클 로딩 중...",
  goldMapError: "3-way 사이클을 가져오지 못했습니다. 백엔드에 문제가 있을 수 있습니다.",
  goldMapRefresh: "새로고침",
  goldMapNoCyclesYet: "아직 3-way 사이클이 없습니다 — 스냅샷에 더 많은 데이터가 필요합니다. 아래 계산기는 수동 gold→Div 변환만 표시합니다.",
  goldMapFetchedAt: "가져온 시간: {0}",
  goldMapCycleCount: "{0}개 사이클 감지됨",
  goldMapInputsTitle: "입력",
  goldMapGoldPerRun: "실행당 골드",
  goldMapMapCost: "지도 비용 (Div)",
  goldMapGoldPerDiv: "1 Div당 골드",
  goldMapRateStaleWarning: "비율이 {0}일 경과 — 여전히 정확한지 확인하세요.",
  goldMapDefaultRateHint: "기본 추정값입니다 — 게임 내 관찰로 업데이트하세요.",
  goldMapInvalidGoldPerDiv: "Div당 골드는 1,000 ~ 10,000,000 사이여야 합니다.",
  goldMapResultTitle: "결과",
  goldMapResultExpectedDiv: "예상 ROI",
  goldMapResultRoiPct: "ROI %",
  goldMapRecommendationLabel: "권장",
  goldMapRecommendationAvoid: "회피 — 음수 ROI",
  goldMapRecommendationMarginal: "경계선 — 지도가 무료일 때 고려",
  goldMapRecommendationFarm: "파밍",
  goldMapRecommendationStrongFarm: "강력 파밍 — 높은 ROI 구간",
  goldMapBreakdownTitle: "내역",
  goldMapBreakdownManualConversion: "골드 → Div (수동 비율)",
  goldMapBreakdownBestCycle: "최적 3-way 체인",
  goldMapBreakdownMapCost: "지도 비용",
  goldMapBreakdownExpectedNet: "예상 순이익",
