...
const zh: Record<TranslationKeys, string> = {
  ...
  tabRecipes: "配方",
  recipesTitle: "商人配方套利",
  recipesDescription: "商人配方允许将货币碎片在商人处兑换为宝珠。当碎片的市场价格低于所得宝珠价值减去金币手续费时，配方即变为盈利。价格通过实时市场数据检查，并根据规范公式计算金币手续费。",
  recipesProfitableCount: "盈利配方",
  recipesTotalChecked: "已检查总数",
  recipesBestProfit: "最佳利润",
  recipesNoData: "配方数据不可用",
  recipesNoDataDesc: "请确保后端正在运行并提供充足的定价数据用于配方计算。",
  recipesNoProfitable: "没有盈利的商人配方",
  recipesNoProfitableDesc: "当前市场条件下没有商人配方盈利。这在稳定市场阶段很常见。请稍后碎片价格变动时再查看。",
  recipesName: "配方",
  recipesInputCost: "投入成本",
  recipesOutputValue: "产出价值",
  recipesGoldFee: "金币手续费",
  recipesProfit: "利润",
  recipesProfitPct: "利润率",
  recipesStatus: "状态",
  recipesMissingPrices: "缺少价格",
  recipesProfitable: "盈利",
  recipesUnprofitable: "亏损",
  recipesShowUnprofitable: "显示亏损配方 ({0})",
