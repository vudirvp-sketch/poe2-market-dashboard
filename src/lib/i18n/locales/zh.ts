...
const zh: Record<TranslationKeys, string> = {
  ...
  phaseHintsLivePriceLabel: "价格",
  phaseHintsChangeWeekLabel: "7日",
  phaseHintsChangeMonthLabel: "30日",
  phaseHintsMomentumUp: "上涨",
  phaseHintsMomentumDown: "下跌",
  phaseHintsMomentumFlat: "平稳",
  phaseHintsRecBuyOpportunity: "买入 — 回调机会",
  phaseHintsRecHold: "持有",
  phaseHintsRecWatch: "关注",
  phaseHintsRecSellIntoStrength: "卖出 — 顺势",
  phaseHintsRecSellNow: "立即卖出",
  phaseHintsRecNeutral: "中性",
  ...
  // Leveling Uniques Lifecycle (P3, iter 100) — Overview 标签页上的小部件
  levelingTitle: "练级传奇装备",
  levelingDayCount: "第 {0} 天",
  levelingItemCount: "{0} 件物品",
  levelingReferenceCurrency: "参考: {0}",
  levelingOffline: "练级传奇装备数据需要分析后端。",
  levelingLoading: "正在加载练级传奇装备生命周期...",
  levelingError: "加载练级传奇装备失败。后端可能遇到问题。",
  levelingNoData: "练级传奇装备不可用 — PhaseDetector 无法确定当前联赛日。",
  levelingNoUniques: "静态表中没有练级传奇装备。",
  levelingRefresh: "刷新",
  levelingFetchedAt: "获取时间: {0}",
  levelingStageBreakdown: "峰值前: {0} · 峰值时: {1} · 峰值后: {2}",
  levelingSummaryAtPeak: "{0} 件物品处于需求峰值 — 如果有就现在出售。",
  levelingSummaryPrePeak: "{0} 件物品仍在涨向峰值 — 买入或持有。",
  levelingSummaryPostPeak: "{0} 件物品已过峰值 — 避免购买（价格下跌）。",
  levelingStagePrePeak: "峰值前",
  levelingStageAtPeak: "峰值时",
  levelingStagePostPeak: "峰值后",
  levelingStageUnknown: "未知",
  levelingRecBuyOrHold: "买入/持有",
  levelingRecSellNow: "立即出售",
  levelingRecAvoidBuying: "避免购买",
  levelingRecUnknown: "—",
  levelingColItem: "物品",
  levelingColStage: "阶段",
  levelingColEstPrice: "估价",
  levelingColPeakDay: "峰值日",
  levelingColAction: "操作",
  levelingPeakDayShort: "第 {0} 天",
  levelingDisclaimer: "估价是基于联赛日的启发式规划，不是实时市场价格。交易前请务必核实实际挂牌价。",
  fallbackLevelingUniques: "练级传奇装备小部件",

  // Mirror/Divine Arbitrage (P7, iter 109) — 单对象汇率检测器标签页
  tabMirrorDivineArb: "Mirror/Div",
  fallbackMirrorDivineArb: "Mirror/Divine 套利 — 汇率检测器",
  mirrorDivineTitle: "Mirror ↔ Divine 套利",
  mirrorDivineSubtitle: "当前 Mirror:Divine 汇率 vs 过去 {0} 天窗口均值。|z| ≥ 1.5 → EXECUTE_ARB。|z| ∈ [1.0, 1.5) → WATCH。|z| < 1.0 → HOLD。",
  mirrorDivineOffline: "Mirror/Divine 套利需要分析后端。",
  mirrorDivineOfflineHint: "启动 FastAPI 后端以启用汇率检测。",
  mirrorDivineLoading: "正在计算 Mirror:Divine 汇率...",
  mirrorDivineError: "计算 Mirror:Divine 汇率失败。后端可能遇到问题。",
  mirrorDivineNoData: "暂无价格历史 — 调度器需要收集更多 Mirror 和 Divine 价格快照才能分析汇率。",
  mirrorDivineNoSample: "回溯窗口内汇率点不足 (需要 ≥ 4)。请尝试扩大回溯窗口。",
  mirrorDivineRefresh: "刷新",
  mirrorDivineFetchedAt: "获取时间: {0}",
  mirrorDivineDaysLabel: "回溯窗口 (天)",
  mirrorDivineDaysValue: "{0} 天",
  mirrorDivineSignalLabel: "信号",
  mirrorDivineSignalSellMirror: "卖 MIRROR / 买 DIVINE",
  mirrorDivineSignalSellDivine: "卖 DIVINE / 买 MIRROR",
  mirrorDivineSignalNeutral: "中性",
  mirrorDivineActionLabel: "操作",
  mirrorDivineActionExecute: "执行套利",
  mirrorDivineActionWatch: "观察",
  mirrorDivineActionHold: "持有",
  mirrorDivineCurrentRate: "当前汇率",
  mirrorDivineCurrentRateTitle: "最新的 mirror_price / divine_price (每个 Mirror 的 Div)",
  mirrorDivineRateUnit: "Div / Mirror",
  mirrorDivineZScore: "z 分数",
  mirrorDivineZScoreTitle: "(当前 - 均值) / 标准差。|z| ≥ 1.5 → 可执行信号。",
  mirrorDivineZScoreHint: "+高估 · -低估",
  mirrorDivineDeviation: "偏差",
  mirrorDivineDeviationTitle: "相对于均值的带符号 % 偏差。正值 = Mirror 相对 Div 高估。",
  mirrorDivineDeviationHint: "相对窗口均值",
  mirrorDivineProfit: "每 Mirror 利润:",
  mirrorDivineProfitTitle: "|当前 - 均值| (每 Mirror 的 Div)。1 Mirror 交换的套利利润潜力。",
  mirrorDivineActionable: "可执行:",
  mirrorDivineActionableYes: "是",
  mirrorDivineActionableNo: "否",
  mirrorDivineMean: "均值",
  mirrorDivineMeanTitle: "回溯窗口内汇率的历史均值",
  mirrorDivineStd: "标准差",
  mirrorDivineStdTitle: "窗口内汇率的样本标准差 (ddof=1)",
  mirrorDivineMin: "最小",
  mirrorDivineMinTitle: "窗口内观察到的最低汇率",
  mirrorDivineMax: "最大",
  mirrorDivineMaxTitle: "窗口内观察到的最高汇率",
  mirrorDivineSampleSizeLabel: "点数",
  mirrorDivineSampleSizeTitle: "回溯窗口内的汇率点数",
  mirrorDivineSampleSize: "{0} 点",
  mirrorDivineSparklineLabel: "回溯窗口内的 Mirror:Divine 汇率",

  // Gold Map ROI (P10 Phase 1 MVP, iter 127) — Castaway 运行 ROI 计算器
  tabGoldMapRoi: "Gold ROI",
  fallbackGoldMapRoi: "Gold Map ROI — Castaway 运行",
  goldMapTitle: "ROI Gold Map (Castaway)",
  goldMapSubtitle: "通过最佳 3-way 链将 gold → Div 转换，减去地图成本。当 ROI > 50% 时推荐刷图。",
  goldMapOffline: "Gold Map ROI 需要分析后端。",
  goldMapOfflineHint: "启动 FastAPI 后端以启用 3-way 循环检测。",
  goldMapLoading: "加载 3-way 循环中...",
  goldMapError: "获取 3-way 循环失败。后端可能遇到问题。",
  goldMapRefresh: "刷新",
  goldMapNoCyclesYet: "尚无 3-way 循环 — 快照需要更多数据。下方计算器仅显示手动 gold→Div 转换。",
  goldMapFetchedAt: "获取时间: {0}",
  goldMapCycleCount: "检测到 {0} 个循环",
  goldMapInputsTitle: "输入",
  goldMapGoldPerRun: "每次运行的 gold",
  goldMapMapCost: "地图成本 (Div)",
  goldMapGoldPerDiv: "每 1 Div 的 gold",
  goldMapRateStaleWarning: "汇率已 {0} 天 — 请验证其是否仍然准确。",
  goldMapDefaultRateHint: "这是默认估算值 — 请根据游戏内观察更新。",
  goldMapInvalidGoldPerDiv: "每 Div 的 gold 必须在 1,000 到 10,000,000 之间。",
  goldMapResultTitle: "结果",
  goldMapResultExpectedDiv: "预期 ROI",
  goldMapResultRoiPct: "ROI %",
  goldMapRecommendationLabel: "建议",
  goldMapRecommendationAvoid: "避免 — 负 ROI",
  goldMapRecommendationMarginal: "边缘 — 地图免费时考虑",
  goldMapRecommendationFarm: "刷图",
  goldMapRecommendationStrongFarm: "强力刷图 — 高 ROI 窗口",
  goldMapBreakdownTitle: "明细",
  goldMapBreakdownManualConversion: "Gold → Div (手动汇率)",
  goldMapBreakdownBestCycle: "最佳 3-way 链",
  goldMapBreakdownMapCost: "地图成本",
  goldMapBreakdownExpectedNet: "预期净利",
