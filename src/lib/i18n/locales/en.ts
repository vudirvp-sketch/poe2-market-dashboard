...
const en = {
  ...
  portfolioCorrelationPlaceholder: "Correlation matrix requires backend support",
  portfolioCorrelationPlaceholderDesc: "The full correlation matrix will be displayed here when the backend exposes it via the portfolio endpoint. Currently, only the correlation shock warning is available.",
