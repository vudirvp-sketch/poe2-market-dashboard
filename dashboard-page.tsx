...
export function Dashboard() {
  ...
  // --- Comparison store ---
  // Fix React #310: Use targeted selectors instead of destructuring the entire store.
  // Previously: const { comparisonIds, pairComparisonIds, alerts } = useDashboardStore();
  // This subscribed to EVERY store property change, causing Dashboard to re-render
  // on any store mutation (e.g., rehydration, favorite toggles in child components).
  const comparisonIds = useDashboardStore((s) => s.comparisonIds);
